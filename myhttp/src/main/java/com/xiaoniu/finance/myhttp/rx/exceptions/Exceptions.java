...
public final class Exceptions {
     ...
     * @return because {@code propagate} itself throws an exception or error, this is a sort of phantom return value; {@code propagate} does not actually return anything
     */
     ...
     * </ul>
     * This can be useful if you are writing an call that calls user-supplied code, and you want to
     ...
     * @return the last {@code Throwable} in the causality-chain of {@code e} (or a "Stack too deep to get final cause" {@code RuntimeException} if the chain is too long to
     * traverse)
     */
     ...
     *
     * @param exceptions the collection of exceptions. If null or empty, no exception is thrown. If the collection contains a single exception, that exception is either thrown
     * as-is or wrapped into a CompositeException. Multiple exceptions are wrapped into a CompositeException.
     * @since 1.1.0
     */
     ...
     * @since 1.3
     */
    public static void throwOrReport(Throwable t, Callback<?> o, Object value) {
     ...
     * @since 1.3
     */
    public static void throwOrReport(Throwable t, Callback<?> o) {
        Exceptions.throwIfFatal(t);
        o.onError(t);
    }
}
