...
//    private static final String keyBytes = "XDUwLC6AZDpZpRbWARLcGA==";

    private static byte[] keyBytes = { 92, 53, 48, 44, 46, -128, 100, 58, 89, -91, 22, -42, 1, 18, -36, 24 };
...
//        byte[] b = decrypt(parseHexStr2Byte(content), keyBytes);
        byte[] b = decrypt(content, keyBytes);
        return new String(b);
    }
