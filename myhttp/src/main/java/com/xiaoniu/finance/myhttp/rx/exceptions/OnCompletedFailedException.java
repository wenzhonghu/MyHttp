...
public final class OnCompletedFailedException extends RuntimeException {
     ...
     *
     * @param throwable the {@code Throwable} to re-throw; if null, a NullPointerException is constructed
     */
     ...
     *
     * @param message the message to assign to the {@code Throwable} to re-throw
     * @param throwable the {@code Throwable} to re-throw; if null, a NullPointerException is constructed
     */
