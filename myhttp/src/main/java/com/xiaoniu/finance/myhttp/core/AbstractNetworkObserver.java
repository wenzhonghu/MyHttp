 ...
 */
abstract class AbstractNetworkObserver extends BroadcastReceiver {

    private PhoneStateListener signalListener;
    private volatile int cellLevel = -1;
    /**
     * 提示: android.telephony.SignalStrength是Android 2.1(API Level 7)及以后才提供
     */
    ...
    /**
     * EVDO网络显示 CDMA2000 3G信号显示（例如电信天网3G
     */
