...
/**
 * 移动网络接入点枚举，同时包含了中国大陆运营商的常用接入点 <br>
 * <br>
 * <i>使用枚举的意图是方便在程序的代码中使用switch来处理不同接入点的策略逻辑</i><br>
 * <br>
 */
public enum AccessPoint {
     ...
     * 接入点不可用，常是无网络或非移动网络
     */
    NONE(StrUtils.EMPTY, ServiceProvider.NONE, false),
    /**
     * 未知的接入点
     */
    NEVER_HEARD("I don't know", ServiceProvider.NEVER_HEARD, false), // 未知接入
    /**
     * 中国移动 cmnet
     */
     ...
     *
     * @param name 接入点名
     * @return 接入点枚举对<br> <br> 如果名称为空，得到{@link AccessPoint.NONE}<br> 如果并非此枚举中的范围，得到{@link AccessPoint.NEVER_HEARD}
     */
