 ...
 */
package com.xiaoniu.finance.myhttp.rx.exceptions;
...
/**
 * Represents a {@code Throwable} that an {@code AsyncJob} might notify its subscribers of, but that then can
 * be handled by an call that is designed to recover from or react appropriately to such an error. You can
 * recover more information from an {@code OnErrorThrowable} than is found in a typical {@code Throwable}, such
 * as the item the {@code AsyncJob} was trying to emit at the time the error was encountered.
 */
public final class OnErrorThrowable extends RuntimeException {
     ...
     *
     * @return {@code true} if there is a value associated with this {@code OnErrorThrowable}, otherwise {@code false}
     */
     ...
     *
     * @param t the {@code Throwable} to convert; if null, a NullPointerException is constructed
     ...
     * @return the same {@code Throwable} ({@code e}) that was passed in, with {@code value} added to it as a cause
     */
    ...
    /**
     * Represents an exception that was encountered while trying to emit an item from an AsyncJob, and
    ...
    public static class OnNextValue extends RuntimeException {
         ...
         *
         * @param value the item that the AsyncJob was trying to emit at the time of the exception
         */
        ...
        /**
         * Retrieve the item that the AsyncJob was trying to emit at the time this exception occurred.
         *
         * @return the item that the AsyncJob was trying to emit at the time of the exception
         */
        public Object getValue() {
            return value;
        }
         ...
         *
         * @param value the item that the AsyncJob was trying to emit at the time of the exception
         * @return a string version of the object if primitive or managed through error plugin, otherwise the class name of the object
         */
